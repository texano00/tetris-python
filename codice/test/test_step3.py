...
class TestStep3(unittest.TestCase): 
    ...
    def test_P1(self):
        ...
        self.assertEqual([2], data['data']['play']['user2']['done'])

        data = addMove('user1',1,data) #USER1 PLAY 1
        ...
        self.assertEqual([1], data['data']['play']['user1']['done'])
        ...
        self.assertEqual("user2", data['data']['last_play']['usr'])
        self.assertEqual([2,3], data['data']['play']['user2']['done'])
        ...
        self.assertEqual("user1", data['data']['last_play']['usr'])
        self.assertEqual([1,4], data['data']['play']['user1']['done'])

        data = addMove('user2',5,data) #USER2 PLAY 5
        self.csocket2.send(message().encode(data))
        ##END USER2
        ...
        self.assertEqual("user2", data['data']['last_play']['usr'])
        self.assertEqual([2,3,5], data['data']['play']['user2']['done'])

        data = addMove('user1',7,data) #USER1 PLAY 7
        self.csocket1.send(message().encode(data))
        ##END USER1

        ##USER1 KNOW THAT IS THE WINNER
        data = self.csocket1.recv(1024)
        data = message().decode(data)
        self.assertEqual("user1", data['data']['winner'])

        ##USER2 KNOW THAT IS NOT THE WINNER
        data = self.csocket2.recv(1024)
        data = message().decode(data)
        self.assertNotEqual("user2", data['data']['winner'])
    ...
    def test_P2(self):
        ...
        data = addMove('user2',9,data) #USER2 PLAY 9
        self.csocket2.send(message().encode(data))
        ##END USER2
        ...
        self.assertEqual("user2", data['data']['last_play']['usr'])
        self.assertEqual([9], data['data']['play']['user2']['done'])
        ...
        self.assertEqual(3, data['data']['last_play']['move'])
        self.assertEqual("user1", data['data']['last_play']['usr'])
        self.assertEqual([3], data['data']['play']['user1']['done'])
        ...
        self.assertEqual("user2", data['data']['last_play']['usr'])
        self.assertEqual([9,6], data['data']['play']['user2']['done'])
        ...
        self.assertEqual(5, data['data']['last_play']['move'])
        self.assertEqual("user1", data['data']['last_play']['usr'])
        self.assertEqual([3,5], data['data']['play']['user1']['done'])
        ...
        self.assertEqual("user2", data['data']['last_play']['usr'])
        self.assertEqual([9,6,8], data['data']['play']['user2']['done'])
    ...
    def test_P3(self):
        ...
        data = addMove('user2',1,data) #USER2 PLAY 2
        self.csocket2.send(message().encode(data))
        ##END USER2
        ...
        data = addMove('user2',4,data) #USER2 PLAY 5
        self.csocket2.send(message().encode(data))
        ##END USER2
        ...
        self.assertEqual(4, data['data']['last_play']['move'])
        self.assertEqual("user2", data['data']['last_play']['usr'])
        self.assertEqual([1,2,4], data['data']['play']['user2']['done'])
...
if __name__=="__main__":
    ...
    if len(part)==0:
        ...
        for t in part:
            ...
            print "Adding test: {}\n".format(testName)
            suite.addTest(TestStep3(testName))
